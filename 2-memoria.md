...
> Respuesta
Dado que la memoria se establece en 300m
--memory-swap=1g establece la memoria total (RAM+SWAP) en 1024MB, el espacio es de 
1024-300=724 MB
Por lo tanto, el contenedor puede utilizar hasta 724MB de memoria swap.
